...
'''env = DoomGameEnv(Scenarios[4], Algos[3], render = False, load = "", loadpath = "./Train/TrainDeadly_Corridor_4/PPO/Best_Model_100000.zip")
...
env = DoomGameEnv(Scenarios[8], Algos[3], render = True, load = "", loadpath = "./Train/Train/CurriculumDeadly_Corridor_4/PPO/Best_Model_200000.zip")'''

env = DoomGameEnv(Scenarios[4], Algos[3], render = True, load = "", loadpath = "")
